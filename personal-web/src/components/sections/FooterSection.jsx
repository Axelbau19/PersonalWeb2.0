...
export const FooterSection = () => {
    ...
    const AnimatedGradientLine = () => {
        <div className="absolute top-0 left-0 w-full h-px overflow-hidden">
            <motion.div
                className={`h-px bg-gradient-to-r ${isDarkMode ? "from-transparent via-blue-500 to-transparent" :
    ...
    return (
        <footer
            ref={footerRef}
            className={`relative ${isDarkMode ? 'bg-gray-950 text-white' : "bg-white text-gray-950"} overflow-hidden`}>
                ...
                <div className="max-w-6xl mx-auto">
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <motion.p>
                                Crafting insights experiences with passion and precision

                            </motion.p>

                        </motion.div>

                        <motion.div variants={itemVar} className="flex justify-center space-x-6 ">
                        ...
                        <motion.div variants={itemVar} className="space-y-2">
                            <p className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>
                                © {new Date().getFullYear()} XW∅LVE. All rights reserved
                            </p>
